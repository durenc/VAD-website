...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col selection:bg-blood-red selection:text-white font-['Inter'] overflow-x-hidden">
      <div className="fixed inset-0 z-[-1]" style={{ backgroundImage: `url('https://media.istockphoto.com/id/1468889693/photo/vascular-system-veins.jpg?s=612x612&w=0&k=20&c=GyH4LznLxdJDeh6nsiITiITiKKtKqrd_U3FnXpVe65XBDE=')`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat', filter: 'brightness(1.0)' }}></div>
      {/* Navigation */}
