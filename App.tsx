...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col selection:bg-blood-red selection:text-white font-['Inter'] overflow-x-hidden">
      <div className="fixed inset-0 z-[-1]" style={{ backgroundImage: `url('/images/processed-0618CD9F-A8FD-4A8C-A15C-07CFD9254F98.jpeg')`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat', filter: 'brightness(1.0)' }}></div>
      {/* Navigation */}
